...
<div class="container">
    <div class="row">
        ...
        <div class="col-8 fs-5 text-db">
            <p class="m-3 px-5 text-center text-lb display-5 fw-medium">Om Skønhedssalon Theia</p>
            <p class=" m-3 px-5">Vi startede vores rejse i 2022 under navnet <span
                        class="fw-medium">Klinik S.K.Ø.N</span>, og vi er stolte af den udvikling, vi har gennemgået
                siden da. I takt med at vi voksede, blev det tid til forandring: nyt navn, nye rammer, samme passion.
            </p>
            <p class="m-3 px-5 "> Vi har skiftet navn fra <span class="fw-medium">Klinik S.K.Ø.N</span> til
            ...
            <p class="m-3 px-5">Vores mission, som hos <span class="fw-medium">Klinik S.K.Ø.N</span>, er fortsat den
                samme – at give dig en <span class="fst-italic">personlig, professionel og skøn oplevelse</span> hver
                gang du besøger os.
            <p class="text-center fw-medium fs-4">Vi glæder os til at byde dig velkommen i vores nye omgivelser!</p>
        </div>
        <div class="col">
