...
<div class="container">
    <div class="row">
        <div class="justify-content-center align-items-center text-overlay">
            ...
            <p class="text text-lb ps-lg-5 fw-medium display-5 text-center mt-5 mb-3" style="font-family: Zodiak">Om Skønhedssalon THEIA</p>

            <div class="col-12 col-lg-10 col-md-10 fs-5 text-db">
                <p class="col-12 offset-lg-4 col-lg-7 offset-md-3 col-md-10 fs-5 text-db">Vi startede vores rejse i 2022 under navnet <span
                ...
                <p class="col-12 offset-lg-4 col-lg-7 offset-md-3 col-md-10 fs-5 text-db"> Vi har skiftet navn fra <span class="fw-semibold">Klinik S.K.Ø.N</span> til
                ...
                <p class="col-12 offset-lg-4 col-lg-7 offset-md-3 col-md-10 fs-5 text-db">Vores mission, som hos <span class="fw-semibold">Klinik S.K.Ø.N</span>, er fortsat
                    den
                    samme – at give dig en <span class="fst-italic">personlig, professionel og skøn oplevelse</span>
                    hver
                    gang du besøger os.
                <p class="text-center fw-semibold fs-4 col-md-12 col-lg-9 offset-lg-3 offset-md-2">Vi glæder os til at byde dig velkommen i vores nye
                    omgivelser!</p>
            </div>
        </div>
    </div>
...
<div class="container-fluid bg-wd">
    <div class="row">
        ...
        <div class="col-12 col-lg-6 col-md-8">
            ...
            <p class="fs-5 text-db pb-5 px-4 text-start">Bag <span style="font-family:'Zodiak-Bold' ">Skønhedssalon THEIA</span>
