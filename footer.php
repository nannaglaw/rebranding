    ...
    <div class="p-5 border-lb border-top">
        ...
        <div class="col col-md-6 col-lg-6">
            ...
            <div class="ps-5">
                ...
                <p><span class="fw-medium">Adresse:</span> Skovsøgade 9,
                    4200 Slagelse</p>
        ...
        <div class="col col-md-6 col-lg-6">
            ...
            <p class="m-1"><span class="fw-medium">Tirsdag:</span> 9.30 - 17.30</p>
            <p class="m-1"><span class="fw-medium">Onsdag:</span> 9.30 - 17.30 </p>
            <p class="m-1"><span class="fw-medium">Torsdag:</span> 9.30 - 20.00</p>
            <p class="m-1"><span class="fw-medium">Fredag:</span> 9.30 - 17.30</p>
