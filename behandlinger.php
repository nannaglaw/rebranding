    ...
    <div class="container">
            ...
            <div class="accordion custom-accordion" id="accordionTen">
                <div class="accordion-item border border-wd rounded shadow-sm">
                    ...
                    <div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingTen"
                        ...
                        <div class="accordion-body">
                            <p class="px-lg-5 px-4 pt-3">Aftagning af vipper er <span class="kursiv">gratis</span> hvis du har fået lavet vipperne her i skønhedssalonen. Hvis du ønsker aftagning af vipper som er lavet hos en anden er <span class="fed">prisen 100 kr.</span> </p>
        ...
        <div class="col-12 col-lg-6 mt-lg-4 mt-md-4 mt-4">
            ...
            <div id="collapseEleven" class="accordion-collapse collapse" aria-labelledby="headingEleven"
                ...
                <div class="accordion-body">
                    <p class="px-lg-5 px-4 pt-3">Farvning af vipper giver dine øjne et mere defineret og vågent look uden behov for mascara.
                        Behandlingen er ideel for dem, der ønsker mørkere vipper, men ikke vil bruge makeup dagligt.
                        Det er velegnet til personer med lyse vipper, aktive livsstile eller dem med sarte øjne, der ønsker at undgå irritation fra mascara.
                ...
                <div class="accordion rounded-2 custom-accordion" id="accordionTwelve">
                    <div class="accordion-item border border-wd rounded shadow-sm">
                        ...
                        <div id="collapseTwelve" class="accordion-collapse collapse" aria-labelledby="headingTwelve"
                            ...
                            <div class="accordion-body">
                                <p class="px-lg-5 px-4 pt-3"><span class="fed">Før:</span>Til behandlingen Eyelash-extensions er det vigtigt at der ikke er
                                    nogle produkter på vipperne, herunder mascara. Hvis du fjerne mascara lige inden behandlingen anbefaler vi at bruge en
                                    øjenmakeupfjerne som ikke indeholder olie, for det bedst mulige resultat af behandlingen.</p>
                                <p class="px-lg-5 px-4">Derudover må du ikke have kontaktlinser i under behandlingen. </p>
                                <p class="px-lg-5 px-4"><span class="fed">Efter:</span> Efter at have fået lash extensions, bør du undgå vand på vipperne i de
                                    første 24-48 timer, da limen skal hærde. Brug ikke olieholdige produkter eller mascara på vipperne, da det kan forkorte deres
                                    holdbarhed. Vask dine vipper regelmæssigt med en mild, olie-fri rens og undgå at gnide eller trække i dem. Sørg for at sove på
                                    ryggen eller bruge en satin-pude for at minimere friktion. For at bevare et fyldigt look, anbefales opfyldning hver 2-3 uge.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion custom-accordion" id="accordionThirteen">
                    <div class="accordion-item border border-wd rounded shadow-sm">
                        ...
                        <div id="collapseThirteen" class="accordion-collapse collapse" aria-labelledby="headingThirteen"
                            ...
                            <div class="accordion-body">
                                <p class="px-lg-5 px-4 pt-3">At plukke sine bryn med en pincet giver præcise og definerede bryn, da du kan fjerne
                                    de enkelte hår, der ikke passer til din ønskede form. Det giver et skarpere og mere naturligt resultat sammenlignet
                                    med voks eller trådning. Pincetmetoden er ideel til små justeringer og for dem, der ønsker fuld kontrol over formen
                                    og tyndheden af deres bryn.</p>
                                <p class="px-lg-5 px-4"><span class="fed">Behandlingen varer 20 min. </span></p>

                                <p class="px-lg-5 px-4"><span class="fed">Holdbarhed:</span> Variere meget ift. hårtype og hårvækst</p>
                ...
                <div class="accordion custom-accordion" id="accordionFourteen">
                    <div class="accordion-item border border-wd rounded shadow-sm">
                        ...
                        <div id="collapseFourteen" class="accordion-collapse collapse" aria-labelledby="headingFourteen"
                            ...
                            <div class="accordion-body">
                                <p class="px-lg-5 px-4 pt-3">Farvning af øjenbryn giver et mere defineret og fyldigt look,
                                    samtidig med at det sparer tid på makeup. Det er ideelt for dem med lyse eller tynde bryn,
                                    da det skaber en markeret og naturlig farve, der holder i flere uger. Farvning gør brynene mere fremtrædende og
                                    passer perfekt til en skarpere ansigtsprofil uden behov for daglig påføring af brynfarve.</p>
                                <p class="px-lg-5 px-4 ">Behandlingen kan ligges til <span class="kursiv">Ret af bryn m. pincet.</span> </p>
                                <p class="px-lg-5 px-4"><span class="fed">Behandlingen varer 25 min. </span></p>

                                <p class="px-lg-5 px-4"><span class="fed">Holdbarhed:</span> Typisk 3-4 uger</p>
                                <p class="px-lg-5 px-4"><span class="fed">Pris:</span> 70 kr. (inkl. ret af bryn med pincet) </p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="accordion-item border border-wd rounded shadow-sm">
                        ...
                        <div id="collapseFifteen" class="accordion-collapse collapse" aria-labelledby="headingFifteen"
                            ...
                            <div class="accordion-body">
                                ...
                                <p class="px-lg-5 px-4">Shellac hel farve er perfekt til dig, der ønsker glansfulde, ensfarvede negle med lang holdbarhed.
                                    Behandlingen passer til en travl hverdag og giver stærkere negle uden afskalning.</p>
                ...
                <div class="accordion custom-accordion" id="accordionSixteen">
                    <div class="accordion-item border border-wd rounded shadow-sm">
                        ...
                        <div id="collapseSixteen" class="accordion-collapse collapse" aria-labelledby="headingSixteen"
                            ...
                            <div class="accordion-body">
                                <p class="px-lg-5 px-4 pt-3">Behandlingen inkluderer valgfri shellac-farve på egne negle,
                                    formning af neglene samt klip af neglebånd. Denne behandling er til dig, der ønsker negledesign
                                    – f.eks. fransk kant, blomster eller kreative mønstre på mere end to negle</p>
                                <p class="px-lg-5 px-4">
                                    Hvis du ønsker et mere specifikt design, er du meget velkommen til at kontakte mig inden behandlingen, så jeg kan vurdere, om det er muligt for mig at udføre.
                ...
                <div class="accordion custom-accordion" id="accordionSeventeen">
                    <div class="accordion-item border border-wd rounded shadow-sm">
                        ...
                        <div id="collapseSeventeen" class="accordion-collapse collapse" aria-labelledby="headingSeventeen"
                            ...
                            <div class="accordion-body">
                                <p class="px-lg-5 px-4 pt-3">Behandlingen inkluderer aftagning af nuværende shellac, samt formning
                                    af neglene og klipning af neglebånd. Herefter påføres ny valgfri shellac-farve på dine naturlige negle evt. med design. </p>
                                <p class="px-lg-5 px-4"><span class="fed">Behandlingen varer 80 min. </span></p>
                                <p class="px-lg-5 px-4"><span class="fed">Holdbarhed:</span> Anbefaler opfriskning efter 2-3 uger</p>
                                <p class="px-lg-5 px-4"><span class="fed">Pris:</span> 350 kr. </p>
                                <p class="px-lg-5 px-4 fed"><span class="fedkursiv">OBS.</span> For nye kunder tillægges der et ekstra beløb på 50 kr. </p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion custom-accordion" id="accordionEighteen">
                    <div class="accordion-item border border-wd rounded shadow-sm">
                        ...
                        <div id="collapseEighteen" class="accordion-collapse collapse" aria-labelledby="headingEighteen"
                            ...
                            <div class="accordion-body">
                                <p class="px-lg-5 px-4 pt-3">Behandlingen inkluderer formning af neglene, samt klipning af neglebånd og forstærkning.
                                    Herefter påføres ny valgfri shellac-farve evt. med design. </p>
                                <p class="px-lg-5 px-4">Forstærkning er ideelt, hvis du ønsker ekstra holdbarhed og beskyttelse af dine naturlige negle.
                                    Forstærkningen gør neglene mere modstandsdygtige over for brud og giver et flot, glansfuldt resultat, der holder endnu
